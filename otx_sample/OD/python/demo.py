...
#        print(f"test: {model.labels}")
        models.append(model)         

#    print(f"Jerry 0000 {args.inference_type} {models[0].labels}")
    inferencer = get_inferencer_class(args.inference_type, models)

    # create visualizer
#    print(f"Jerry 1111 {models[-1].task_type}")
    ...
    print(f"Jerry 5555 {demo.annotation_scene}")
    result = str(demo.annotation_scene)
